...
// Remove common markdown markers for previews
...
export default function CampaignDetailPage({
  ...
  // Prefer EN columns when locale is 'en'
  const displayName = locale === 'en' 
    ? ((campaign as any).campaign_name_en || campaign.campaign_name)
    : campaign.campaign_name;
  const displayDescription = locale === 'en'
    ? ((campaign as any).campaign_description_en || (campaign as any).campaign_discription_en || campaign.campaign_description)
  ...
  return (
    <PageLayout
      ...
      breadcrumbs={[
        ...
        { name: displayName, href: `/${locale}/campaigns/${slug}` }
      ]}
      variant="minimal"
    >
                      ...
                      {relatedCampaigns.map((relatedCampaign) => {
                        ...
                        return (
                          <Link
                            ...
                            href={`/${locale}/campaigns/${relatedSlug}`}
                          ...
                          >
                            <h4 className="font-medium text-neutral-900 dark:text-neutral-100 mb-1 line-clamp-2">
                              {locale === 'en' ? (relatedCampaign as any).campaign_name_en || relatedCampaign.campaign_name : relatedCampaign.campaign_name}
                            </h4>
                            <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-2 line-clamp-2">
                              {stripMarkdown(
                                locale === 'en' 
                                  ? ((relatedCampaign as any).campaign_description_en || (relatedCampaign as any).campaign_discription_en || relatedCampaign.campaign_description)
                                  : relatedCampaign.campaign_description,
                                160
                              )}
                            </p>
                            <div className="flex items-center justify-between">
