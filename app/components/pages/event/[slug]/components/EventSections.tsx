              ...
              >
                <div className="flex items-center space-x-4 flex-1">
                  <div className="flex-shrink-0">
                    <div className="w-8 h-8 bg-neutral-100 dark:bg-neutral-700 rounded-sm flex items-center justify-center text-sm font-medium text-neutral-600 dark:text-neutral-400">
                      {sectionIndex + 1}
                    </div>
                  </div>
              ...
              {openSections[sectionIndex] && section.lessons && (
                <div className="border-t border-neutral-200 dark:border-neutral-700">
                  ...
                  {section.lessons.map((lesson: Lesson, lessonIndex: number) => (
                    <div 
                      key={lesson.id} 
                      className={`flex items-center justify-between p-4 border-b border-neutral-100 dark:border-neutral-700 last:border-b-0 hover:bg-neutral-50 dark:hover:bg-neutral-700/30 transition-colors cursor-pointer group ${
                    ...
                    >
                      <div className="flex items-center space-x-4 flex-1">
                        ...
                        <div className="flex-shrink-0">
                          {lesson.isCompleted ? (
                            <div className="w-6 h-6 bg-neutral-600 dark:bg-neutral-400 rounded-full flex items-center justify-center">
                              <svg className="w-3 h-3 text-white" fill="white" viewBox="0 0 20 20">
                                <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                              </svg>
                            </div>
                          ) : lesson.isLocked ? (
                            <div className="w-6 h-6 bg-neutral-200 dark:bg-neutral-600 rounded-full flex items-center justify-center">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center space-x-3 mb-1">
                            ...
                            <span className="text-xs px-2 py-1 rounded-sm bg-neutral-100 dark:bg-neutral-700 text-neutral-600 dark:text-neutral-400 font-medium">
