      ...
      <div className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-sm overflow-hidden">
        <div className="p-8">
          ...
          <div className="relative">
            <div className="bg-neutral-100 dark:bg-neutral-700 rounded-sm p-6 border border-neutral-200 dark:border-neutral-600">
              ...
              <div className="grid grid-cols-12 gap-4 h-48">
                {/* Left Sidebar */}
                <div className="col-span-3 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-sm p-4 space-y-2">
                  <div className="h-2 bg-neutral-200 dark:bg-neutral-600 rounded-sm"></div>
                  <div className="h-2 bg-[#990000] rounded-sm w-3/4"></div>
                  <div className="h-2 bg-neutral-200 dark:bg-neutral-600 rounded-sm w-1/2"></div>
                  <div className="h-2 bg-neutral-200 dark:bg-neutral-600 rounded-sm"></div>
                </div>
                
                {/* Main Content */}
                <div className="col-span-6 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-sm p-4">
                  <div className="h-24 bg-neutral-200 dark:bg-neutral-600 rounded-sm mb-4 flex items-center justify-center">
                    <div className="w-8 h-8 bg-neutral-400 rounded-sm flex items-center justify-center">
                  ...
                  <div className="space-y-2">
                    <div className="h-2 bg-neutral-200 dark:bg-neutral-600 rounded-sm"></div>
                    <div className="h-2 bg-neutral-200 dark:bg-neutral-600 rounded-sm w-2/3"></div>
                  </div>
                </div>
                
                {/* Right Sidebar */}
                <div className="col-span-3 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-sm p-4 space-y-3">
            ...
            <div className="absolute -top-2 -left-2 bg-neutral-800 dark:bg-neutral-600 text-white px-2 py-1 rounded-sm text-xs font-medium">
              MyUNI Sections
            </div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 bg-neutral-800 dark:bg-neutral-600 text-white px-2 py-1 rounded-sm text-xs font-medium">
              MyUNI Video
            </div>
            <div className="absolute -bottom-2 -right-2 bg-neutral-800 dark:bg-neutral-600 text-white px-2 py-1 rounded-sm text-xs font-medium">
              MyUNI AI
            </div>
          </div>
        </div>
