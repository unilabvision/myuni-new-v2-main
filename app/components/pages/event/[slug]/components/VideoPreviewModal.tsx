...
const VideoPreviewModal: React.FC<VideoPreviewModalProps> = ({
  ...
  const handlePurchaseClick = () => {
    // Buraya satın alma sayfasına yönlendirme eklenebilir
                    ...
                    <div className="bg-white/95 dark:bg-neutral-900/95 backdrop-blur-md rounded-2xl p-6 w-full sm:w-auto sm:max-w-sm text-center shadow-lg border border-neutral-200/30 dark:border-neutral-700/30">
                      ...
                      <div className="space-y-3">
                        <button
                          ...
                          className="w-full bg-[#990000] hover:bg-[#800000] text-white px-6 py-3 rounded-xl font-medium transition-colors text-sm"
                        >
                          Kursa Kayıt Ol
                        </button>
                        <button
