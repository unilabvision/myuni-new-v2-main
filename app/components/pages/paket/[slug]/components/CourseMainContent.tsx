  ...
  useEffect(() => {
    const fetchCourseData = async () => {
      try {
        ...
        setCourse(packageData);

        // myuni_packages uses jsonb for objectives and requirements
        const objData = Array.isArray(packageData.objectives) 
          ? packageData.objectives.map((text: string, index: number) => ({ id: String(index), objective_text: text, order_index: index }))
          : [];
        setObjectives(objData);

        const reqData = Array.isArray(packageData.requirements)
          ? packageData.requirements.map((text: string, index: number) => ({ id: String(index), requirement_text: text, order_index: index }))
          : [];
          ...
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
              ...
              <div className="text-left sm:col-span-2 lg:col-span-1">
                ...
                <p className="text-xs sm:text-sm text-neutral-600 dark:text-neutral-400 leading-relaxed">
                  Paket içerisindeki kursların sonunda geçerli bir dijital sertifika kazanın
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              {objectives.length > 0 ? (
                ...
                <div className="text-neutral-600 dark:text-neutral-400">
                  Bu paket için henüz hedefler tanımlanmamış.
                </div>
              )}
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-4">
              {requirements.length > 0 ? (
                ...
                <div className="text-neutral-600 dark:text-neutral-400">
                  Bu paket için özel gereksinim bulunmuyor.
                </div>
              )}
            </div>
          </div>
            ...
            {!enrollmentChecked ? (
              ...
              <form onSubmit={submitComment} className="mb-6 bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-sm p-4">
                ...
                <textarea
                  ...
                  placeholder="Paket hakkındaki düşüncelerinizi paylaşın..."
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-blue-800 dark:text-blue-200 text-sm font-medium">
                      Yorum yapmak için paketi satın alın
                    </p>
                    <p className="text-blue-600 dark:text-blue-300 text-xs">
                      Paketi satın aldıktan sonra yorum yapabilirsiniz
                    </p>
                  </div>
                </div>
              </div>
