...
/** @deprecated Use /api/admin/applications/[id] */
export async function GET(
  ...
  return NextResponse.json({
    ...
    application: {
      ...result.application,
      opportunity_id: result.application.context_id,
      opportunity: result.application.opportunity,
    },
...
export async function PATCH(
  ...
  try {
    ...
    console.error('[admin/opportunity-applications/id] PATCH:', error);
